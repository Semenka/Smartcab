...
class Environment(object):
    ...
    def sense(self, agent):
        ...
        state = namedtuple('state',['light','oncoming','left','right','location','heading'])
        current_state=state(light,oncoming,left,right,location,heading)
        # print (current_state[0])
        return {'light': current_state[0], 'oncoming': current_state[1], 'left': current_state[2], 'right': current_state[3],'location':current_state[4],'heading':current_state[5]}
